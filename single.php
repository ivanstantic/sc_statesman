...
<?php get_header(); ?>
    ...
    <div class="w-full flex items-center justify-center  ">
        <div class="lg:w-[80%] w-[90%]">
            <div class="flex justify-center items-center flex-col mt-[3rem]">
                <!-- Header Section -->
                <div class="xl:w-[60%] lg:w-[80%]">
                <p class="text-blue-600 text-[14px] font-bold font-roboto-serif">State</p>
                <h1 class="lg:text-[3rem] md:text-[2.5rem] sm:text-[2.5rem] text-[2rem]  leading-[52px] font-bold mt-2 w-[77%]">South Carolina's Coastal Development</h1>
                ...
                <!-- Author Info Section -->
                <div class="flex items-center mt-4 xl:w-[60%] lg:w-[80%] w-[100%]">
                  <img 
                  ...
                  />
                  <div>
                    <p class="font-bold text-gray-800 font-[16px] dark:text-white">Alexis Monroe</p>
                    <p class="text-[14px] text-gray-500">Senior Reporter</p>
                  </div>
                </div>
            
                <!-- Date Section -->
                <p class="text-[14px] text-gray-500 mt-2 xl:w-[60%] lg:w-[80%] w-[100%]">October 10, 2023</p>
              </div>
        </div>
    </div>
    
    <div class="w-full flex items-center justify-center bg-[#f2f3f4] dark:bg-[#1B2228] pt-10 pb-14">
        <div class="md:w-[80%] w-[90%]">
            <div class="xl:w-[60%] lg:w-[80%]  self-center mx-auto border-t-2 pt-10">
                ...
                <div class="mt-8 rounded-lg flex items-start">
                  <img
                    src="assets/images/audio-placeholder.png" 
    ...
    <div class="w-full flex items-center justify-center bg-[#f2f3f4] dark:bg-[#1B2228]">
        <div class="xl:w-[70%] lg:w-[80%] w-[90%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 py-8">
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-9.png" alt="Card Image"
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-10.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-11.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
    ...
    <hr class="border-none h-[1px] bg-[#cbd5e1]" />
    <div class="w-full flex items-center justify-center bg-[#f2f3f4] dark:bg-[#1B2228]">
        <div class="w-[90%] flex justify-between items-center pt-[24px] pb-[0px]">
            <div class="text-[32px] font-bold">
    ...
    <div class="w-full flex items-center justify-center bg-[#f2f3f4] dark:bg-[#1B2228]">
        <div class="w-[90%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 py-8">
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-4.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-5.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-6.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-7.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
            ...
            <div class="dark:bg-[#1B2228] overflow-hidden">
                <img src="assets/images/grid/grid-8.png" alt="Card Image"
                    class="w-full h-[220px] object-cover rounded" />
                <div class="py-4">
                    <h3
                        class="text-[20px] font-semibold text-gray-800 dark:text-white leading-[24px] font-medium font-roboto-serif">
