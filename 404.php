    ...
    <section class="flex-1 bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <a href="/" class="inline-flex text-white bg-black hover:bg-hc-gray-dark focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center my-4 tracking-widest">
                    BACK TO HOMEPAGE
                </a>
            </div>   
        </div>
